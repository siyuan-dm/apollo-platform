...
g++ -shared -o _participant.so participant_wrap.cxx -std=c++11 -fpic -I/usr/include/python3.6/ -I../fast-rtps_$MACHINE_ARCH/include/ -I$ROS_INCLUDE -L$ROS_LIB -ldiscovery
